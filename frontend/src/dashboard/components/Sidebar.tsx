  ...
  const navGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        { key: 'leads', label: 'Leads', icon: <UserPlus size={18} /> },
        { key: 'opportunities', label: 'Opportunities', icon: <Target size={18} /> },
      ],
    },
    {
      title: 'SALES',
      items: [
        { key: 'sales', label: 'Sales Orders', icon: <TrendingUp size={18} /> },
        { key: 'orders', label: 'Challans', icon: <ShoppingCart size={18} /> },
    ...
    },
    {
      title: 'OPERATIONS',
      items: [
        { key: 'products', label: 'Products Catalog', icon: <Package size={18} /> },
        { key: 'inventory', label: 'Inventory Control', icon: <Boxes size={18} /> },
        { key: 'employees', label: 'Employees', icon: <UserCheck size={18} /> },
      ],
    },
    {
      title: 'ANALYTICS',
      items: [
        { key: 'reports', label: 'Reports & Audits', icon: <FileBarChart size={18} /> },
    ...
    },
    {
      ...
      items: [
        ...
        { key: 'rbac', label: 'Roles & RBAC', icon: <ShieldCheck size={18} /> },
